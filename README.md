...
* [@sentry/remix](https://github.com/getsentry/sentry-javascript/tree/master/packages/remix) ⭐ 8,717 | 🐛 592 | 🌐 TypeScript | 📅 2026-08-13 - Error and performance monitoring of your Remix apps with [Sentry](https://sentry.io/)
...
* [@aeorank/remix](https://github.com/vinpatel/aeorank/tree/main/packages/remix) ⭐ 12 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-13 - Scores your Remix app's AI visibility and generates the 9 files (llms.txt, ai.txt, CLAUDE.md, ...) that ChatGPT and Perplexity read.
...
* [cool-stack](https://github.com/tdsoftpl/cool-stack) ⭐ 35 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-12 - Template repository integrating Remix & Directus into a full-stack monorepo.
...
* [Runnable](https://github.com/kineticio/runnable) ⭐ 88 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-11 - Low-code admin workflows, built on Remix
