...
* [@sentry/remix](https://github.com/getsentry/sentry-javascript/tree/master/packages/remix) ⭐ 8,738 | 🐛 695 | 🌐 TypeScript | 📅 2026-09-04 - Error and performance monitoring of your Remix apps with [Sentry](https://sentry.io/)
...
* [remix-auth](https://github.com/sergiodxa/remix-auth) ⭐ 2,201 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-31 - Simple Authentication for Remix
...
* [@aeorank/remix](https://github.com/vinpatel/aeorank/tree/main/packages/remix) ⭐ 14 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-06 - Scores your Remix app's AI visibility and generates the 9 files (llms.txt, ai.txt, CLAUDE.md, ...) that ChatGPT and Perplexity read.
...
* [kpop-stack](https://github.com/netlify-templates/kpop-stack) ⭐ 251 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-07 - Create a Remix app with Netlify, Tailwind, TypeScript and more!
...
* [cool-stack](https://github.com/tdsoftpl/cool-stack) ⭐ 36 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-05 - Template repository integrating Remix & Directus into a full-stack monorepo.
...
* [kentcdodds.com](https://github.com/kentcdodds/kentcdodds.com) ⭐ 2,494 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-04
...
* [Runnable](https://github.com/kineticio/runnable) ⭐ 88 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-07 - Low-code admin workflows, built on Remix
