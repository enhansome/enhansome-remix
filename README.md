...
* [@sentry/remix](https://github.com/getsentry/sentry-javascript/tree/master/packages/remix) ⭐ 8,740 | 🐛 713 | 🌐 TypeScript | 📅 2026-09-17 - Error and performance monitoring of your Remix apps with [Sentry](https://sentry.io/)
* [remix-utils](https://github.com/sergiodxa/remix-utils) ⭐ 2,365 | 🐛 31 | 🌐 TypeScript | 📅 2026-08-01 - A set of utility functions and types to use with Remix.run
* [remix-auth](https://github.com/sergiodxa/remix-auth) ⭐ 2,201 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-14 - Simple Authentication for Remix
...
* [remix-i18next](https://github.com/sergiodxa/remix-i18next) ⭐ 716 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-14 - The easiest way to translate your Remix apps
...
* [@aeorank/remix](https://github.com/vinpatel/aeorank/tree/main/packages/remix) ⭐ 14 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-16 - Scores your Remix app's AI visibility and generates the 9 files (llms.txt, ai.txt, CLAUDE.md, ...) that ChatGPT and Perplexity read.
...
* [Stripe Stack](https://github.com/dev-xo/stripe-stack) ⭐ 1,454 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-01 - A Stripe focused Remix Stack that integrates User Subscriptions, Authentication and Testing. Driven by Prisma ORM. Deploys to Fly.io
...
* [kpop-stack](https://github.com/netlify-templates/kpop-stack) ⭐ 251 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-15 - Create a Remix app with Netlify, Tailwind, TypeScript and more!
...
* [cool-stack](https://github.com/tdsoftpl/cool-stack) ⭐ 36 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-15 - Template repository integrating Remix & Directus into a full-stack monorepo.
...
* [kentcdodds.com](https://github.com/kentcdodds/kentcdodds.com) ⭐ 2,494 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-16
...
* [Runnable](https://github.com/kineticio/runnable) ⭐ 88 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-16 - Low-code admin workflows, built on Remix
