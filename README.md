...
* [@sentry/remix](https://github.com/getsentry/sentry-javascript/tree/master/packages/remix) ⭐ 8,744 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-12 - Error and performance monitoring of your Remix apps with [Sentry](https://sentry.io/)
...
* [@aeorank/remix](https://github.com/vinpatel/aeorank/tree/main/packages/remix) ⭐ 14 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-12 - Scores your Remix app's AI visibility and generates the 9 files (llms.txt, ai.txt, CLAUDE.md, ...) that ChatGPT and Perplexity read.
...
* [Runnable](https://github.com/kineticio/runnable) ⭐ 88 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-13 - Low-code admin workflows, built on Remix
