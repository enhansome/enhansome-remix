...
* [@aeorank/remix](https://github.com/vinpatel/aeorank/tree/main/packages/remix) ⭐ 14 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-24 - Scores your Remix app's AI visibility and generates the 9 files (llms.txt, ai.txt, CLAUDE.md, ...) that ChatGPT and Perplexity read.
...
* [kpop-stack](https://github.com/netlify-templates/kpop-stack) ⭐ 251 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-24 - Create a Remix app with Netlify, Tailwind, TypeScript and more!
