...
* [@sentry/remix](https://github.com/getsentry/sentry-javascript/tree/master/packages/remix) ⭐ 8,720 | 🐛 602 | 🌐 TypeScript | 📅 2026-08-19 - Error and performance monitoring of your Remix apps with [Sentry](https://sentry.io/)
* [remix-utils](https://github.com/sergiodxa/remix-utils) ⭐ 2,369 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-01 - A set of utility functions and types to use with Remix.run
...
* [remix-i18next](https://github.com/sergiodxa/remix-i18next) ⭐ 715 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-17 - The easiest way to translate your Remix apps
...
* [remix-themes](https://github.com/abereghici/remix-themes) ⭐ 158 | 🐛 8 | 🌐 TypeScript | 📅 2025-06-26 - An abstraction for themes in your Remix app.
...
* [@aeorank/remix](https://github.com/vinpatel/aeorank/tree/main/packages/remix) ⭐ 12 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-18 - Scores your Remix app's AI visibility and generates the 9 files (llms.txt, ai.txt, CLAUDE.md, ...) that ChatGPT and Perplexity read.
...
* [kpop-stack](https://github.com/netlify-templates/kpop-stack) ⭐ 251 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-17 - Create a Remix app with Netlify, Tailwind, TypeScript and more!
...
* [cool-stack](https://github.com/tdsoftpl/cool-stack) ⭐ 35 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-18 - Template repository integrating Remix & Directus into a full-stack monorepo.
...
* [kentcdodds.com](https://github.com/kentcdodds/kentcdodds.com) ⭐ 2,493 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-17
...
* [Runnable](https://github.com/kineticio/runnable) ⭐ 88 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-18 - Low-code admin workflows, built on Remix
